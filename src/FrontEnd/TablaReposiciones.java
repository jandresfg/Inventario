...
public class TablaReposiciones extends AbstractTableModel {
    ...
    String colNames[] = {"Almacen", "Proveedor", "Fecha", "Fecha de Llegada", "Referencia", "CategorÌa","NumeraciÛn", "Planta", "Altura", "Color", "Material", "Cantidad", "Precio Costo", "Precio Venta"};
