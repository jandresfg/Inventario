    ...
    public DialogoAgregarZapto(Principal pprincipal) {
        ...
        btnNewButton_1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                DialogoAgregarZapto.this.setVisible(false);
                DialogoAgregarZapto.this.dispose();
            }
        });
        ...
        if (e.getActionCommand().equals(AGREGAR)) {
            try {
                ...
                try {
                    ...
                    if (precioCosto == -1) {
                        JOptionPane.showMessageDialog(this, "Precio de Costo ingresado inv谩lido", "Agregar Zapato", JOptionPane.ERROR_MESSAGE);
                    }
                } catch (NumberFormatException e1) {
                    JOptionPane.showMessageDialog(this, "Precio de Costo ingresado inv谩lido", "Agregar Zapato", JOptionPane.ERROR_MESSAGE);
                }
                ...
                try {
                    ...
                    if (precioVenta == -1) {
                        JOptionPane.showMessageDialog(this, "Precio de Venta ingresado inv谩lido", "Agregar Zapato", JOptionPane.ERROR_MESSAGE);
                    }
                } catch (NumberFormatException e1) {
                    JOptionPane.showMessageDialog(this, "Precio de Venta ingresado inv谩lido", "Agregar Zapato", JOptionPane.ERROR_MESSAGE);
                }
                ...
                try {
                    ...
                    if (cantidad == -1) {
                        JOptionPane.showMessageDialog(this, "Cantidad ingresada inv谩lida", "Agregar Zapato", JOptionPane.ERROR_MESSAGE);
                    }
                } catch (NumberFormatException e1) {
                    JOptionPane.showMessageDialog(this, "Cantidad ingresada inv谩lida", "Agregar Zapato", JOptionPane.ERROR_MESSAGE);
                }
                ...
                if (precioCosto != -1 && precioVenta != -1 && cantidad != -1) {
                    ...
                    if (provs.size() > 1) {
                        throw new Exception("S贸lo puede seleccionar un Proveedor a la vez. Hay " + provs.size() + " seleccionados.");
                    }
                    if (provs.size() == 0) {
