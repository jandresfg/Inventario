...
public class TablaTotalesPorAlmacen  extends AbstractTableModel 
{
	    ...
	    String colNames[] = { "Almacen", "Referencia", "Proveedor", "Cantidad Total", "Precio Costo Total", "Precio Venta Total"  };
	    Class<?> colClasses[] = { String.class, String.class, String.class, Integer.class , Integer.class, Integer.class };
